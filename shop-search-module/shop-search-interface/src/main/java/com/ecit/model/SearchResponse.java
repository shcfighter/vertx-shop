...
public class SearchResponse extends AbstractSearchResponse<SearchResponse> {
    ...
    private Map<String, Map<String, Object>> aggregations = new HashMap<>();
    ...
    public SearchResponse(JsonObject json) {
        ...
        if (jsonAggregations != null) {
            for (String name : jsonAggregations.fieldNames()) {
                aggregations.put(name, jsonAggregations.getJsonObject(name).getMap());
            }
        }
    }
    ...
    public SearchResponse setAggregations(Map<String, Map<String, Object>> aggregations) {
