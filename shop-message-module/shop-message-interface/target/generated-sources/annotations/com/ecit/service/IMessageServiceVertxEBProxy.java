...
public class IMessageServiceVertxEBProxy implements IMessageService {
  ...
  public IMessageServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public IMessageServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public IMessageService saveMessage(String destination, RegisterType type, Handler<AsyncResult<String>> resultHandler) {
    ...
    _json.put("type", type == null ? null : type.toString());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "saveMessage");
  ...
  public IMessageService findMessage(String destination, RegisterType type, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("type", type == null ? null : type.toString());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "findMessage");
