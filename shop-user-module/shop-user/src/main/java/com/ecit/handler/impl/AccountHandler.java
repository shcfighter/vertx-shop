...
public class AccountHandler extends JdbcRxRepositoryWrapper implements IAccountHandler {
     ...
     */
    @Override
    public IAccountHandler payOrder(long userId, long orderId, String payPwd, Handler<AsyncResult<Integer>> handler) {
        IOrderHandler orderService = new ServiceProxyBuilder(vertx.getDelegate())
                .setAddress(IOrderHandler.ORDER_SERVICE_ADDRESS).build(IOrderHandler.class);
    ...
    @Override
    public IAccountHandler changePayPwd(long userId, String payPwd, String code, Handler<AsyncResult<Integer>> handler) {
