...
public class OrderHandler extends JdbcRxRepositoryWrapper implements IOrderHandler {
     ...
     */
    @Override
    public IOrderHandler findPageOrder(long userId, Integer status, int size, int page, Handler<AsyncResult<List<JsonObject>>> handler) {
    ...
    @Override
    public IOrderHandler findOrderRowNum(long userId, Integer status, Handler<AsyncResult<JsonObject>> handler) {
    ...
    @Override
    public IOrderHandler preparedInsertOrder(JsonArray params, Handler<AsyncResult<String>> handler) {
     ...
     */
    @Override
    public IOrderHandler findPreparedOrder(String id, Handler<AsyncResult<JsonObject>> handler) {
        Future<JsonObject> future = Future.future();
     ...
     */
    @Override
    public IOrderHandler refund(long orderId, long userId, int refundType, String refundReason, String refundMoney, String refundDescription, Handler<AsyncResult<UpdateResult>> handler) {
