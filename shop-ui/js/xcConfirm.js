...
(function($){
    ...
    jQuery.Pop  = function(Html,Type,Callback) {
        ...
        var $Box=$("<div>").addClass("box-alter").addClass(Config.Class);
        ...
        function Style(){
            var css=".box-alter{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-family: 'Microsoft YaHei', '微软雅黑', 'Lantinghei SC', 'Open Sans', Arial, 'Hiragino Sans GB', 'STHeiti', 'WenQuanYi Micro Hei', SimSun, sans-serif;background-color:#fff;position:fixed;left:50%;top:50%;min-width:500px;box-shadow:0 5px 15px rgba(0,0,0,.5);border:1px solid rgba(0,0,0,.2);border-radius:6px}.box-title i{position:absolute;right:10px;top:5px;font-size:25px;color:#999;cursor:pointer;font-style:normal}.box-title i:hover{color:#222}.box-title{position:relative;width:100%;padding:15px 0;min-height:10px;border-bottom:1px solid #e5e5e5;text-indent:15px;font-size:18px;font-weight:500;color:#333;box-sizing:border-box}.box-content{min-height:90px;width:100%;padding:10px 15px 25px 15px;font-size:14px;box-sizing:border-box}.box-button{width:100%;padding:13px 15px;border-top:1px solid #e5e5e5;text-align:right;box-sizing:border-box}.box-button span{margin:0 5px}";
